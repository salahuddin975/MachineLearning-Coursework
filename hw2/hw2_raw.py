...
def update_hidden_layer_weight(input_layer, hidden_delta):
    for i in range(input_layer_size):
        for j in range(first_hidden_layer_size):
            ...
            first_hidden_layer_weights[j][i] = first_hidden_layer_weights[j][i] + delta_w
...
#    plot_dataset(train_dataset)
    ...
    #            print (output_layer)
                ...
                output_delta = []
                compute_output_layer_delta(output_layer, label[i], output_delta)
                update_output_layer_weight(first_hidden_layer, output_delta)

                hidden_delta = []
                compute_hidden_layer_delta(first_hidden_layer, output_delta, hidden_delta)
...
if __name__ == '__main__':
    ...
    first_hidden_layer_weights = np.random.random((first_hidden_layer_size, input_layer_size))
